            ...
            <form method="post" action="<?= base_url('client/ticket_form/'); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 contact-field-custom">
                        <select class="form-control" id="type" name="type" value="<?= set_value('type'); ?>" autofocus>
                            <option>---</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 contact-field-custom select-editable">
                        <select class="form-control-custom" value="<?= set_value('subject'); ?>" onchange="this.nextElementSibling.value=this.value">
                            <option>---</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 contact-field-custom">
                        <textarea rows="4" class="form-control" id="description" name="description" value="<?= set_value('description'); ?>"></textarea>
