<div class="dashboard-wrapper">
    <div class="card">
        <div class="card-body">
            <?= form_open_multipart('agent/update_ticket/'); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 contact-field-custom">
                        ...
                        <a href="<?= base_url('agent/contact_form/'); ?>" class="float-right pr-1">Add New Contact</a>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="agent_name" class="col-sm-2 col-form-label">Assignee</label>
                    <div class="col-sm-10 contact-field-custom">
                        <select class="form-control" id="agent_name" name="agent_name" required>
                            <option>---</option>
                            <?php foreach ($agent as $ag) : ?>
                                <?php if ($ag['name'] == $ticket['agent_name']) : ?>
                ...
                <div class="form-group row float-right">
                    <a href="<?= base_url('agent/ticket_details/'); ?><?= $ticket['id']; ?>/" class="btn btn-secondary">Cancel</a>
...
<script type="text/javascript">
    function autofill() {
        ...
        $.ajax ({
            url: "<?= base_url('agent/ajax_ticket/'); ?>",
            data: {name:name},
